object App {
    const val petproject = "com.android.com"
}
...
object Versions {
    ...
    const val hiltWork = "1.0.0-alpha02"
}
...
object Deps {
    ...
    const val core_utils = "androidx.legacy:legacy-support-core-utils:${Versions.legacy}"
    const val legacy = "androidx.legacy:legacy-support-v4:${Versions.legacy}"

    const val design = "com.google.android.material:material:1.3.0-alpha03"
    ...
    //coroutines
    const val coroutines = "org.jetbrains.kotlinx:kotlinx-coroutines-core:1.3.6"
    const val coroutinesAndroid = "org.jetbrains.kotlinx:kotlinx-coroutines-android:1.3.6"
    const val workCoroutines = "androidx.work:work-runtime-ktx:2.3.4"
